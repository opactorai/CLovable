...
import { GlobalMCPConfig } from '@/components/settings/GlobalMCPConfig';
...
interface GlobalSettingsProps {
  isOpen: boolean;
  onClose: () => void;
  initialTab?: 'general' | 'cli-models' | 'agents' | 'commands' | 'services' | 'mcp' | 'memory' | 'about';
}
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex-1 p-6 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
            ...
            {activeTab === 'mcp' && <GlobalMCPConfig />}

            {activeTab === 'memory' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Global Memory</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                    Edit your global CLAUDE.md file (~/.claude/CLAUDE.md) that applies to all projects
                  </p>
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                    <div className="text-sm text-blue-800 dark:text-blue-300">
                      <strong>Note:</strong> Global memory editing interface coming soon. This will edit ~/.claude/CLAUDE.md which contains your global preferences and patterns.
                    </div>
                  </div>
                </div>
              </div>
