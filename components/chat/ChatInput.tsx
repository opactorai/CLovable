          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex flex-col text-[11px] text-gray-500 ">
              ...
              {modelOptionsForCli.length > 0 ? (
                ...
                <div className="mt-1 w-48 rounded-md border border-dashed border-gray-300 bg-gray-100 text-gray-600 text-xs py-1 px-2">
                  Auto (OpenCode config)
                </div>
              )}
            </div>
          </div>
